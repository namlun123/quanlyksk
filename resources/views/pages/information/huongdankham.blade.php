...
<div class="container mt-5">
  ...
  <div class="row">
    ...
    <div class="col-md-8">
      ...
      <!-- Guide Section -->
      <div class="mb-5 mt-5"> <!-- Thêm margin-top để tạo khoảng cách -->
    <h3 class="text-secondary">Hướng dẫn khám</h3>
    <div class="row">
        <!-- Step 1 -->
        <div class="col-md-6 mb-4"> <!-- Thêm mb-4 để tăng khoảng cách giữa các bước -->
            <div class="card shadow-sm border-success">
                <div class="card-header bg-success text-white">Bước 1</div>
                <div class="card-body">
                    <p class="card-text">Đăng ký lịch khám online.</p>
                    <small class="text-muted">Chi tiết: Vào trang web của HealthCenter đăng ký lịch khám.</small>
                </div>
            </div>
        </div>
        <!-- Step 2 -->
        <div class="col-md-6 mb-4"> <!-- Thêm mb-4 để tăng khoảng cách giữa các bước -->
            <div class="card shadow-sm border-success">
                <div class="card-header bg-success text-white">Bước 2</div>
                <div class="card-body">
                    <p class="card-text">Đến cơ sở khám để in giấy đăng ký lịch.</p>
                    <small class="text-muted">Chi tiết: Đến cơ sở khám, bệnh nhân sẽ có người hướng dẫn in giấy.</small>
                </div>
            </div>
        </div>
        <!-- Step 3 -->
        <div class="col-md-6 mb-4"> <!-- Thêm mb-4 để tăng khoảng cách giữa các bước -->
            <div class="card shadow-sm border-success">
                <div class="card-header bg-success text-white">Bước 3</div>
                <div class="card-body">
                    <p class="card-text">Đến phòng khám chuyên khoa theo hướng dẫn.</p>
                    <small class="text-muted">Chi tiết: Theo dõi bảng điện tử hoặc nhờ nhân viên hỗ trợ.</small>
                </div>
            </div>
        </div>
        <!-- Step 4 -->
        <div class="col-md-6 mb-4"> <!-- Thêm mb-4 để tăng khoảng cách giữa các bước -->
            <div class="card shadow-sm border-success">
                <div class="card-header bg-success text-white">Bước 4</div>
                <div class="card-body">
                    <p class="card-text">Thực hiện các xét nghiệm (nếu cần).</p>
                    <small class="text-muted">Chi tiết: Nhân viên y tế sẽ hướng dẫn cụ thể từng bước.</small>
                </div>
            </div>
        </div>
        <!-- Step 5 -->
        <div class="col-md-6 mb-4"> <!-- Thêm mb-4 để tăng khoảng cách giữa các bước -->
            <div class="card shadow-sm border-success">
                <div class="card-header bg-success text-white">Bước 5</div>
                <div class="card-body">
                    <p class="card-text">Nhận kết quả và tư vấn từ bác sĩ (nếu có).</p>
                    <small class="text-muted">Chi tiết: Kết quả sẽ được trả tại phòng chờ hoặc xem online.</small>
                </div>
            </div>
        </div>
    </div>
